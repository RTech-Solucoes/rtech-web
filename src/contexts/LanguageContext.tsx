...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  const translations = {
    pt: {
      ...
      "contact.form.phonePlaceholder": "(00) 0000-0000",
      ...
      "contact.form.successDescription": "Iremos te responder dentro o mais rápido possível.",
      "contact.form.error": "Erro ao enviar mensagem",
      "contact.form.errorDescription": "Infelizmente houve um erro ao enviar sua mensagem, por favor tente novamente.",
    ...
    en: {
      ...
      "contact.form.phonePlaceholder": "+00 000-0000",
      "contact.form.message": "Project details *",
      "contact.form.messagePlaceholder": "Tell us about your project, your goals, and how we can assist you",
      "contact.form.send": "Send Message",
      "contact.form.success": "Message sent!",
      "contact.form.successDescription": "We will respond as soon as possible.",
      "contact.form.error": "Error sending message",
      "contact.form.errorDescription": "Unfortunately there was an error sending your message, please try again.",
